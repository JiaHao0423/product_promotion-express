...
function intolist(){
    connection.query('SELECT * FROM product',(error, results, fields) => {
        ...
        results.forEach((product) =>{
            ...
            let imageName = 'images/'+product.class+'.jpg';
            newdiv.classList.add('commodity-col');
            newdiv.innerHTML = `
            <div class="commodity-card">
                <div class="card-cover">
                    <p class="card__discount ">${product.discount.toLocaleString()}折</p>
                    <img src="${imageName}" alt="" class="card__img">
                </div>
                <div class="card-content">
                    <p class="card__name">${product.name}</p>
                    <select name="${product.class}_${product.id}" id="${product.class}_${product.id}" class="card__select">
                ...
                <div class="card-oder">
                    <div class="card-price">
                        <div class="card-price__priceafter">$${product.sale_price.toLocaleString()}</div>
                        <div class="card-price__pricebefore">$${product.price.toLocaleString()}</div>
                    </div>
                    <button onclick="addcard('${product.class}',${product.id})" class="card__btn">加入購物車</button>
                </div>
            </div>`;
            renderProductList(product.class,newdiv)
