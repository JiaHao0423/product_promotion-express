    ...
    productData[0].forEach((product) =>{
        ...
        <div class="commodity-card">
            <div class="card-cover">
                <p class="card__discount ">${product.discount}折</p>
            ...
            <div class="card-oder">
                <div class="card-price">
                    <div class="card-price__priceafter">$${product.sale_price}</div>
                    <div class="card-price__pricebefore">$${product.price}</div>
                </div>
